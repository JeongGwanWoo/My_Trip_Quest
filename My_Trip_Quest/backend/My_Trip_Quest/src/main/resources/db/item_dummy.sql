...
('루돌프 모자', 'HAT', '/assets/avatar/rudolphhat.png', 150, TRUE),
('산타 모자', 'HAT', '/assets/avatar/santacap.png', 150, TRUE),
...
('하와이안 바지', 'BOTTOM', '/assets/avatar/Hawaiianpants.png', 150, TRUE),
('청바지', 'BOTTOM', '/assets/avatar/jeans.png', 150, TRUE),
('산타 바지', 'BOTTOM', '/assets/avatar/santapants.png', 150, TRUE),
('루돌프 바지', 'BOTTOM', '/assets/avatar/rudolphpants.png', 150, TRUE),
